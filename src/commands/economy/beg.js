...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    try {
      ...
      interaction.editReply(`You begged and earned ${coinsEarned} DolphinBucks. Your new balance is ${newBalance} DolphCoins<:DolphCoin:1127314299665264760><:DolphToken:1127314332317929503><:DolphinBucks:1127314182648373291>.`);
    } catch (error) {
