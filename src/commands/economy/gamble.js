  ...
  callback: async (client, interaction) => {
    ...
    try {
      ...
      if (chance < 0.5) {
        ...
        await userLevel.save();
        interaction.editReply(`You gambled ${amount} DolphinBucks and won ${winnings} DolphinBucks!<:DolphCoin:1127314299665264760><:DolphToken:1127314332317929503><:DolphinBucks:1127314182648373291>`);
      }
    } catch (error) {
